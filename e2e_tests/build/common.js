...
exports.RELAY_ASSET_ID = exports.sleep = exports.setupRelayAsset = exports.submitExtrinsic = void 0;
const RELAY_ASSET_ID = 1;
exports.RELAY_ASSET_ID = RELAY_ASSET_ID;
...
async function setupRelayAsset(api, signer) {
    ...
    const assetSetupCalls = [
        ...
        api.tx.assetRate.create(RELAY_ASSET_ID, 1000000000000000000n), // 1 on 1
        api.tx.tokens.setBalance(signer.address, RELAY_ASSET_ID, 10n ** 12n, 0),
    ];
...
exports.setupRelayAsset = setupRelayAsset;
