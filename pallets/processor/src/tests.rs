...
use crate::mock::{new_test_ext, Orders, Processor, Regions, RuntimeOrigin, Test};
use frame_support::{
	assert_ok,
...
fn fulfill_order_works() {
	new_test_ext(vec![(1, 1000), (2000, 1000), (10, 1000), (11, 1000), (12, 1000)]).execute_with(
		|| {
			let region_owner = 1;
			...
			assert_ok!(Orders::contribute(RuntimeOrigin::signed(12), 0, 700));
